-- USER
insert into app_user (email, first_name, last_name, password)
...
-- USER_TASKS
insert into app_user_tasks (tasks_id, users_email)
...
-- USER_PROJECTS
insert into app_user_projects (projects_id, users_email)
values (1, 'maxim@intec.be');
